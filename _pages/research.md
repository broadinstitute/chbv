...
<img src="/assets/img/experimental_design.png" alt="Table describing the number of samples and assays in the cell atlas" height="100%" width="100%" display="block" margin-left="auto" margin-right="auto">
...
<img src="/assets/img/cell_type_composition_variation.png" alt="Transcriptome similarity across cell types and variation in cell type abundance across donors" height="100%" width="100%" display="block" margin-left="auto" margin-right="auto">
